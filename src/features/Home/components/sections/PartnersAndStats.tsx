    ...
    <section className="bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        ...
        <h3 className="text-center text-2xl font-bold text-gray-900">
          الأنظمة والشركاء المدعومون
        </h3>
        <p className="text-center text-gray-600 mt-2">
          ندمج مع أفضل أنظمة العقارات في المملكة
        </p>
        ...
        <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          <PartnerCard
            ...
            bg="bg-blue-100"
            title="Gauge"
            subtitle="نظام القياس - تكامل كامل"
          />
          <PartnerCard
            icon={<MousePointer className="h-6 w-6 text-green-600" />}
            bg="bg-green-100"
            title="Click"
            subtitle="نظام النقر - دعم متقدم"
          />
          <PartnerCard
        ...
        <div className="mt-12 grid grid-cols-2 sm:grid-cols-4 gap-6">
          <Stat value="1000+" label="مستخدم نشط" />
          <Stat value="50K+" label="تقارير تم سحبها" />
          <Stat value="99.9%" label="جاهزية النظام" />
          <Stat value="24/7" label="دعم فني" />
        </div>
      </div>
    </section>
  );
