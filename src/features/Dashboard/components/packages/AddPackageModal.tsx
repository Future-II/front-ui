    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-xl max-h-[90vh] flex flex-col overflow-hidden">
        ...
        <div className="flex items-center justify-between border-b px-6 py-4">
          <h2 className="text-lg font-semibold">{t('modals.addPackage')}</h2>
        ...
        <div className="px-6 py-4 overflow-y-auto flex-1 space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              { label: t('common.name'), type: 'text', value: '' },
              { label: t('common.price'), type: 'number', value: '' },
              { label: t('packages.users'), type: 'number', value: '' },
              {
              ...
              { label: t('packages.reports'), type: 'number', value: '' },
              { label: t('packages.storage'), type: 'text', value: '' },
            ].map((input, idx) => (
